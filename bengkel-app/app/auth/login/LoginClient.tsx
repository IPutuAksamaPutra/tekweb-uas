  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch(
        "https://tekweb-uas-production.up.railway.app/api/login",
        {
          method: "POST",
          credentials: "include", // 🔥 WAJIB agar cookie dari backend diterima
          headers: { 
      ...
      // ❌ JANGAN SET COOKIE DI FRONTEND
      // Laravel SUDAH set token ke HttpOnly cookie
