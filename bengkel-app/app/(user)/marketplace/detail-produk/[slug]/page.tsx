...
// PERBAIKAN: Menambahkan initialSlug agar sesuai dengan pemanggilan di page.tsx
interface Props {
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <button
                ...
                className="bg-[#FF6D1F] text-white py-5 rounded-2xl font-black shadow-lg hover:bg-orange-600 disabled:bg-gray-300"
              >
              ...
              <button
                ...
                className="bg-slate-900 text-white py-5 rounded-2xl font-black shadow-lg hover:bg-slate-800 disabled:bg-gray-700"
              >
                Beli Sekarang
              </button>
            </div>
